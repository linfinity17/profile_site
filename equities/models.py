...
class Record(models.Model):
	...
	price_open = models.DecimalField(max_digits=19, decimal_places=2, default=0.00)
	price_high = models.DecimalField(max_digits=19, decimal_places=2, default=0.00)
	price_low = models.DecimalField(max_digits=19, decimal_places=2, default=0.00)
	price_close = models.DecimalField(max_digits=19, decimal_places=2, default=0.00)
